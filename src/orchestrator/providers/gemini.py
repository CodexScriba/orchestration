...
class GeminiProvider(BaseProvider):
    """Invoke the Gemini CLI using provider markdown frontmatter config."""
    ...
    def build_command(self, prompt: str | None = None) -> list[str]:
        """Build the Gemini CLI command for execution.
    ...
    def invoke(
        ...
        """Run a Gemini invocation and return its execution result."""
